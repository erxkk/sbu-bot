    ...
    public static class SbuGlobals
    {
        ...
        public static class Guild
        {
            ...
            public static class TheLab
            {
                ...
                public const ulong OWNER = Member.QUAHU;

                public static class Member
                {
                    public const ulong QUAHU = 183319356489465856UL;
                    public const ulong ERXKK = Bot.OWNER;
                }
            }
            ...
            public static class LaFamilia
            {
                ...
                {
                    public const ulong ERXKK = Bot.OWNER;
                    public const ulong SASKIA = 649940500895367178UL;
                    public const ulong COLDJACKLE = 148097828923768832UL;
                }
            }
